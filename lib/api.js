...
module.exports = (function ClassConstructor() {
  ...
  * */
  api.prototype.resendAccountVerification = function ResendAccountVerification(email) {
    var ENDPOINT = 'account/resend';
    return bluebird.promise(function(resolve, reject) {
      if(typeof email !== 'string' || email.indexOf('@') === -1) {
        return reject(ApiError('INVALID_EMAIL', 'Invalid account email.'));
      }
      var tObj = new Transport(auth);
      tObj.timeout(DEFAULT_TIMEOUT);
  ...
  * */
  api.prototype.authenticate = function AuthenticateUser(credentials) {
  ...
  *     data.sessionId - the locally generated session ID, or cookie Id that the user will receive
