...
module.exports = (function ClassConstructor() {
  ...
  * Arguments:
  *   targetEmail - the user that will receive the authorization notification. This must be a valid MyShield user.
  ...
  *   userData.domain (optional) - If the request is made of a different domain than the shield.Auth one, this will overwrite the latter.
